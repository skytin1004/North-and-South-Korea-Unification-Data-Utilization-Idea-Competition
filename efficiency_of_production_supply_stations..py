...
percentage_with_station = (local_products['특산물 위치 20km 이내의 기차역'].sum() / len(local_products)) * 100

# 데이터 구성
labels_selected = ['20km이내에 철도역이 있음', '20km이내에 철도역이 없음']
sizes_selected = [local_products['특산물 위치 20km 이내의 기차역'].sum(),
                  len(local_products) - local_products['특산물 위치 20km 이내의 기차역'].sum()]
